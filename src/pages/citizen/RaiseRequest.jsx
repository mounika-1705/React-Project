      ...
      <form className="request-form" onSubmit={handleSubmit}>
        <div className="form-grid">
          ...
          <div className="form-group">
            ...
            <input type="text" name="fullName" placeholder="e.g. Deepak Giri" onChange={handleChange}  required/>
          </div>

          <div className="form-group">
            <label>Mobile Number</label>
            <input type="text" name="mobile" placeholder="10-digit number" onChange={handleChange} required/>
          </div>

          {/* Row 2 */}
          <div className="form-group">
            <label>Ward</label>
            <input type="text" name="ward" placeholder="e.g. 5" onChange={handleChange} required/>
          </div>
          ...
          <div className="form-group">
            ...
            <input type="text" name="timeSlot" placeholder="e.g. 9:00 AM - 12:00 PM" onChange={handleChange}  required/>
          </div>

          <div className="form-group">
            <label>Address</label>
            <input type="text" name="address" placeholder="House No, Street, Area" onChange={handleChange} required/>
          </div>

          {/* Row 4 */}
          <div className="form-group">
            <label>Latitude</label>
            <input type="text" name="latitude" placeholder="e.g. 19.0760" onChange={handleChange} required/>
          </div>

          <div className="form-group">
            <label>Longitude</label>
            <input type="text" name="longitude" placeholder="e.g. 72.8777" onChange={handleChange}  required/>
          </div>
          ...
          <div className="form-group full-width">
            ...
            <textarea name="description" placeholder="Briefly describe the issue..."
              rows="4"

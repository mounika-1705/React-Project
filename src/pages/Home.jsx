        ...
        {(!user || user.role === 'citizen') && (
          <>
            ...
            <div className="home-card">
              ...
              <button type="button" className="submit-btn" onClick={() => handleNavigation("/raise-request")}>Submit Now</button>
            </div>

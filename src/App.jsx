  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* Citizen Routes */}
        <Route path="/raise-request" element={<RaiseRequest user={user} />}/>
        ...
        {/* Operator Route */}
        <Route path="/assigned" element={<OperatorAssigned user={user} />}/>

        {/* Admin Routes */}
        <Route path="/admin-operators" element={<AdminOperators user={user} />} />
